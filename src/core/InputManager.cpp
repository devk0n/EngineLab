...
bool InputManager::isKeyPressed(int key) const { return m_pressedKeys.contains(key); }
bool InputManager::isKeyHeld(int key) const { return m_heldKeys.contains(key); }
bool InputManager::isKeyReleased(int key) const { return m_releasedKeys.contains(key); }

// Mouse state checks
bool InputManager::isMouseButtonPressed(int button) const { return m_pressedMouseButtons.contains(button); }
bool InputManager::isMouseButtonHeld(int button) const { return m_heldMouseButtons.contains(button); }
bool InputManager::isMouseButtonReleased(int button) const { return m_releasedMouseButtons.contains(button); }
